...
from randovania.gui.generated.metroid_game_export_dialog_ui import Ui_PlanetsZebethGameExportDialog
...
class PlanetsZebethGameExportDialog(GameExportDialog, Ui_PlanetsZebethGameExportDialog):
    ...
    def _on_output_file_button(self):
        output_dir = prompt_for_output_directory(self, "Planets Zebeth Randomizer", self.output_file_edit)
