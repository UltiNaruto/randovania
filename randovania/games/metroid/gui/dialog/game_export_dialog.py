...
from randovania.gui.generated.metroid_game_export_dialog_ui import Ui_MetroidGameExportDialog

if TYPE_CHECKING:
    from randovania.interface_common.options import Options


class MetroidGameExportDialog(GameExportDialog, Ui_MetroidGameExportDialog):
    ...
    def __init__(self, options: Options, patch_data: dict, word_hash: str, spoiler: bool, games: list[RandovaniaGame]):
        ...
        assert isinstance(per_game, MetroidPerGameOptions)
    ...
    def _on_output_file_button(self):
        output_dir = prompt_for_output_directory(self, "Metroid Randomizer", self.output_file_edit)
