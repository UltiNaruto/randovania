...
class MetroidPatchDataFactory(PatchDataFactory):
    cosmetic_patches: MetroidCosmeticPatches
    configuration: MetroidConfiguration
    ...
    def _get_item_data(self):
        item_data = json_lib.read_path(
            RandovaniaGame.METROID.data_path.joinpath("pickup_database", "item_data.json")
        )
    ...
    def create_data(self) -> dict:
        ...
        useless_target = PickupTarget(pickup_creator.create_nothing_pickup(db.resource_database, "spr_ITEM_Nothing"),
        ...
        pickup_list = pickup_exporter.export_all_indices(
            ...
            visual_nothing=pickup_creator.create_visual_nothing(self.game_enum(), "spr_ITEM_Unknown"),
        )
