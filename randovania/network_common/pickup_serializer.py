...
from randovania.game_description.resources.pickup_entry import PickupEntry, MAXIMUM_PICKUP_PROGRESSION, \
    MAXIMUM_PICKUP_RESOURCES, MAXIMUM_PICKUP_CONVERSION, ConditionalResources, ResourceConversion, ResourceLock
...
class BitPackPickupEntry:
    ...
    def bit_pack_encode(self, metadata) -> Iterator[Tuple[int, int]]:
        ...
        yield from bitpacking.encode_tuple(self.value.convert_resources, helper.encode_resource_conversion)
    ...
    def bit_pack_unpack(cls, decoder: BitPackDecoder, database: ResourceDatabase) -> PickupEntry:
        ...
        convert_resources = bitpacking.decode_tuple(decoder, helper.decode_resource_conversion)
